<template>
    <div>
        ...
        <div v-if="bmi !== null">
            ...
            <p>{{ BMICategory(bmi) }}</p>
            <img class="bmi--img" v-if="selectImg === '저체중'" src='../assets/low.jepg'>
            <img class="bmi--img" v-else-if="selectImg === '정상체중'" src='../assets/normal.jpeg'>
            <img class="bmi--img" v-else-if="selectImg === '과체중'" src='../assets/high.jpeg'>
            <img class="bmi--img" v-else src='../assets/danger.jpeg'>
